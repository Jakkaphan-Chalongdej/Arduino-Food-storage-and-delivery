...
# define limitPinX 9  // Switch X
# define limitPinY 10 // Switch y
# define limitPinZ 11 // Switch z
# define limitPin 13 // Sensor Infrared
...
void loop () {
  ...
  if(digitalRead(limitPin)==HIGH)
  {
    ...
    {
      step (false, X_DIR, X_STP, 7000);// X axis motor reverse 1 ring, the 7000 step is a circle.
      delay (5000);
      step (true, X_DIR, X_STP, 7000); // X axis motor forward 1 laps, the 7000 step is a circle.
